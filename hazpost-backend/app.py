...
def create_app():
    ...
    # ============================================================
    # Endpoint público usado por el frontend para pintar los planes.
    # Mantener aquí como fallback estable para que /register no dependa de
    # una tabla/configuración externa mientras se estabiliza producción.
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=port)        for origin in os.getenv("CORS_ORIGIN", "").split(",")
        if _normalize_origin(origin)
    ]
