...
INDUSTRY_CATALOG = [{'name': 'Restaurante & Comida',
  ...
  'aiContext': {'description': 'Restaurantes, cafeterías, panaderías, heladerías y todo tipo de '
                               'negocios de alimentación que buscan atraer clientes con contenido '
                               'apetitoso y cercano.',
                'content_topics': ['Platos del día y menús especiales con fotos apetitosas',
                ...
                'audience': 'familias, parejas y personas que buscan dónde comer o pedir a '
                            'domicilio',
                'content_formats': ['foto de plato con descripción',
                                    'reel del proceso de preparación',
                                    'carousel de menú semanal',
 ...
 {'name': 'Salud Mental & Coaching',
  'slug': 'coaching',
  'subcategories': [{'name': 'Coach de Vida', 'slug': 'coach-vida'},
 ...
 {'name': 'Belleza & Estética',
  ...
  'aiContext': {'description': 'Salones de belleza, barberías, spas y centros de estética que '
                               'ofrecen servicios de transformación y cuidado personal.',
                'content_topics': ['Antes y después de tratamientos o cortes',
 ...
 {'name': 'Joyería & Relojes',
  'slug': 'joyeria',
  'subcategories': [{'name': 'Joyería', 'slug': 'joyeria-fina'},
 ...
 {'name': 'Tecnología & Software',
  'slug': 'tecnologia',
  'subcategories': [{'name': 'Software & SaaS', 'slug': 'software-saas'},
  ...
  'aiContext': {'description': 'Empresas de tecnología, software, servicios digitales y soluciones '
                               'tech para negocios y consumidores finales.',
                'content_topics': ['Funcionalidades y beneficios del producto o servicio tech',
                ...
                'audience': 'empresarios, emprendedores y profesionales que buscan soluciones '
                            'tecnológicas',
                'content_formats': ['carousel educativo',
                                    'reel de demostración',
                                    'post de caso de éxito',
                                    'infografía de funcionalidades'],
                'keywords': ['tecnología',
                             'innovación',
                             'digital',
                             'software',
 ...
 {'name': 'Electrónica & Electrodomésticos',
  'slug': 'electronica',
  'subcategories': [{'name': 'Tienda de Electrónica', 'slug': 'tienda-electronica'},
 ...
 {'name': 'Hogar & Decoración',
  'slug': 'hogar',
  'subcategories': [{'name': 'Mueblería', 'slug': 'muebleria'},
 ...
 {'name': 'Servicios del Hogar',
  ...
  'subcategories': [{'name': 'Aseo & Limpieza', 'slug': 'aseo-limpieza'},
 ...
 {'name': 'Fitness & Deporte',
  ...
  'aiContext': {'description': 'Gimnasios, entrenadores personales y centros deportivos que ayudan '
                               'a las personas a mejorar su condición física y alcanzar sus metas '
                               'de salud.',
                ...
                'content_formats': ['reel de rutina rápida',
                                    'carousel de tips nutricionales',
                                    'post de transformación',
                                    'video motivacional'],
                'keywords': ['fitness',
                             'ejercicio',
                             'salud',
 ...
 {'name': 'Eventos & Entretenimiento',
  'slug': 'eventos',
  'subcategories': [{'name': 'Fotografía & Video', 'slug': 'fotografia-video'},
 ...
 {'name': 'Mascotas & Veterinaria',
  'slug': 'mascotas',
  'subcategories': [{'name': 'Clínica Veterinaria', 'slug': 'clinica-veterinaria'},
 ...
 {'name': 'Finanzas & Seguros',
  'slug': 'finanzas',
  'subcategories': [{'name': 'Seguros', 'slug': 'seguros'},
 ...
 {'name': 'Legal & Jurídico',
  'slug': 'legal',
  'subcategories': [{'name': 'Abogado', 'slug': 'abogado'},
 ...
 {'name': 'Comercio & Retail',
  'slug': 'retail',
  'subcategories': [{'name': 'Tienda de Variedades', 'slug': 'tienda-variedades'},
 ...
 {'name': 'Arte & Diseño Creativo',
  'slug': 'arte',
  'subcategories': [{'name': 'Estudio de Diseño', 'slug': 'estudio-diseno'},
 ...
 {'name': 'Publicidad & Comunicaciones',
  'slug': 'publicidad',
  'subcategories': [{'name': 'Agencia de Publicidad', 'slug': 'agencia-publicidad'},
 ...
 {'name': 'Logística & Transporte',
  'slug': 'logistica',
  'subcategories': [{'name': 'Mensajería & Domicilios', 'slug': 'mensajeria'},
 ...
 {'name': 'Seguridad & Vigilancia',
  'slug': 'seguridad',
  'subcategories': [{'name': 'Empresa de Vigilancia', 'slug': 'empresa-vigilancia'},
 ...
 {'name': 'Agricultura & Agro',
  'slug': 'agro',
  'subcategories': [{'name': 'Finca & Cultivos', 'slug': 'finca-cultivos'},
 ...
 {'name': 'Industria & Manufactura',
  'slug': 'manufactura',
  'subcategories': [{'name': 'Fábrica & Planta', 'slug': 'fabrica-planta'},
 ...
 {'name': 'Club & Membresías',
  'slug': 'club',
  'subcategories': [{'name': 'Club Empresarial', 'slug': 'club-empresarial'},
 ...
 {'name': 'ONG & Organizaciones Sociales',
  'slug': 'ong',
  'subcategories': [{'name': 'Fundación', 'slug': 'fundacion'},
 ...
 {'name': 'Consultoría & Servicios Profesionales',
  'slug': 'consultoria',
  'subcategories': [{'name': 'Consultoría Empresarial', 'slug': 'consultoria-empresarial'},
