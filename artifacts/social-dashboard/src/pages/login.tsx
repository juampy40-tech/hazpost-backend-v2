  ...
  useEffect(() => {
    ...
    if (googleError) {
      ...
      toast({
        ...
        description: messages[googleError] || "Error desconocido",
        variant: "destructive",
      });
    }
  }, []);
      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8 gap-3">
          ...
          <p className="text-muted-foreground text-sm text-center">
            Accede a tu panel y sigue creando contenido con IA
          </p>
        </div>
          ...
          {totpState ? (
            ...
            <div className="space-y-4">
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground">
                  Entra y continúa gestionando tus publicaciones.
                </p>
              </div>
              ...
              >
                <GoogleIcon />
                <span>Entrar en 1 clic con Google</span>
              </Button>
        ...
        <div className="text-center mt-6 space-y-1.5">
          <p className="text-xs text-muted-foreground">
            hazpost.app — Haz más, publica mejor.
          </p>
