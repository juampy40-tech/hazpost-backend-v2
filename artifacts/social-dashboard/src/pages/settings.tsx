  ...
  return (
    <div className="space-y-8 pb-8 max-w-4xl">
      ...
      */}
      ...
      {/* Biblioteca de Elementos de Marca — OCULTO UX
          Movido conceptualmente a Mis Negocios / Generador Masivo / Cola de Aprobación.
          No borrar lógica todavía: estados, handlers y endpoints quedan intactos para reutilizar después.
      */}
